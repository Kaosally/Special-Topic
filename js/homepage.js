...
// --- 雲端後端網址 ---
const CLOUD_URL = 'https://special-topic.onrender.com';

// ==========================================
// 1. 提交問卷邏輯 (連結雲端版 - 已去掉開場動畫)
// ==========================================
submitBtn.onclick = async (event) => {
    ...
    // 啟動鎖定
    busy = true; 
    submitBtn.innerText = "靈魂匹配中..."; // 換個更有質感的詞
    ...
    try {
        // 發送請求到 Render 雲端
        const response = await fetch(`${CLOUD_URL}/api/match`, {
            method: 'POST',
